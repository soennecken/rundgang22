    ...
    <div className="horoskopOuter">
      <div className="zodiacWrapper">
        ...
        <div className="zodiacHeader">
          ...
          <h1>{props.zodiac}</h1>{zodiac.date_range}
        </div>
        ...
        <table>
            <tbody>
                <tr>
                    <td><p>Color</p></td>
                    <td><p>{zodiac.color}</p></td>
                </tr>
                <tr>
                    <td><p>Compatibility</p></td>
                    <td><p>{zodiac.compatibility}</p></td>
                </tr>
                <tr>
                    <td><p>Lucky Number</p></td>
                    <td><p>{zodiac.lucky_number}</p></td>
                </tr>
                <tr>
                    <td><p>Lucky Time</p></td>
                    <td><p>{zodiac.lucky_time}</p></td>
                </tr>
                <tr>
                    <td><p>Mood</p></td>
                    <td><p>{zodiac.mood}</p></td>
                </tr>
            </tbody>
        </table>
